...
from helpers import prepare_dataset_nli, prepare_train_dataset_qa, \
    ...
    generate_contrast_examples, perturb_example
import os
import json
...
def main():
    ...
    argp.add_argument('--use_contrast_set', action='store_true',
                      help='Evaluate on contrast set instead of the standard validation set.')
    ...
    if training_args.do_eval:
        ...
        if args.use_contrast_set:
            # Generate contrast examples
            contrast_dataset = eval_dataset.map(
                lambda examples: generate_contrast_examples(examples, perturb_example),
                batched=True,
                num_proc=NUM_PREPROCESSING_WORKERS,
            )
            eval_dataset_featurized = contrast_dataset.map(
